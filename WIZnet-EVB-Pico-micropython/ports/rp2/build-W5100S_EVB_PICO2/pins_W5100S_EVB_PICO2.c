...
//
// --af-csv /run/media/totally-not-asuka/Games/MP-REPL/WIZnet-EVB-Pico-micropython/ports/rp2/boards/rp2350_af.csv
// --board-csv /run/media/totally-not-asuka/Games/MP-REPL/WIZnet-EVB-Pico-micropython/ports/rp2/boards/W5100S_EVB_PICO2/pins.csv
// --prefix /run/media/totally-not-asuka/Games/MP-REPL/WIZnet-EVB-Pico-micropython/ports/rp2/boards/rp2_prefix.c
...
const machine_pin_af_obj_t pin_GPIO0_af[] = {
    ...
    AF(7, PIO1, 1), // PIO1
    AF(8, PIO2, 2), // PIO2
    AF(9, XIP_CS1, 0), // QMI_CS1
    AF(10, USB , 0), // USB_OVCUR_DET
};
...
const machine_pin_af_obj_t pin_GPIO1_af[] = {
    ...
    AF(7, PIO1, 1), // PIO1
    AF(8, PIO2, 2), // PIO2
    AF(9, CORESIGHT_TRACE, 0), // TRACECLK
    AF(10, USB , 0), // USB_VBUS_DET
};
...
const machine_pin_af_obj_t pin_GPIO2_af[] = {
    ...
    AF(7, PIO1, 1), // PIO1
    AF(8, PIO2, 2), // PIO2
    AF(9, CORESIGHT_TRACE, 0), // TRACEDATA0
...
const machine_pin_af_obj_t pin_GPIO3_af[] = {
    ...
    AF(7, PIO1, 1), // PIO1
    AF(8, PIO2, 2), // PIO2
    AF(9, CORESIGHT_TRACE, 1), // TRACEDATA1
    AF(10, USB , 0), // USB_OVCUR_DET
    AF(11, UART_AUX, 0), // UART0_RX
};
...
const machine_pin_af_obj_t pin_GPIO4_af[] = {
    ...
    AF(7, PIO1, 1), // PIO1
    AF(8, PIO2, 2), // PIO2
    AF(9, CORESIGHT_TRACE, 2), // TRACEDATA2
    AF(10, USB , 0), // USB_VBUS_DET
};
...
const machine_pin_af_obj_t pin_GPIO5_af[] = {
    ...
    AF(7, PIO1, 1), // PIO1
    AF(8, PIO2, 2), // PIO2
    AF(9, CORESIGHT_TRACE, 3), // TRACEDATA3
    AF(10, USB , 0), // USB_VBUS_EN
};
...
const machine_pin_obj_t machine_pin_obj_table[NUM_BANK0_GPIOS] = {
    [0] = PIN(0, GPIO0, 0, 10, pin_GPIO0_af),
    [1] = PIN(1, GPIO1, 0, 10, pin_GPIO1_af),
    [2] = PIN(2, GPIO2, 0, 11, pin_GPIO2_af),
    [3] = PIN(3, GPIO3, 0, 11, pin_GPIO3_af),
    [4] = PIN(4, GPIO4, 0, 10, pin_GPIO4_af),
    [5] = PIN(5, GPIO5, 0, 10, pin_GPIO5_af),
    [6] = PIN(6, GPIO6, 0, 10, pin_GPIO6_af),
    [7] = PIN(7, GPIO7, 0, 10, pin_GPIO7_af),
    [8] = PIN(8, GPIO8, 0, 10, pin_GPIO8_af),
    [9] = PIN(9, GPIO9, 0, 9, pin_GPIO9_af),
    [10] = PIN(10, GPIO10, 0, 10, pin_GPIO10_af),
    [11] = PIN(11, GPIO11, 0, 10, pin_GPIO11_af),
    [12] = PIN(12, GPIO12, 0, 11, pin_GPIO12_af),
    [13] = PIN(13, GPIO13, 0, 11, pin_GPIO13_af),
    [14] = PIN(14, GPIO14, 0, 12, pin_GPIO14_af),
    [15] = PIN(15, GPIO15, 0, 12, pin_GPIO15_af),
    [16] = PIN(16, GPIO16, 0, 10, pin_GPIO16_af),
    [17] = PIN(17, GPIO17, 0, 10, pin_GPIO17_af),
    [18] = PIN(18, GPIO18, 0, 11, pin_GPIO18_af),
    [19] = PIN(19, GPIO19, 0, 12, pin_GPIO19_af),
    [20] = PIN(20, GPIO20, 0, 10, pin_GPIO20_af),
    [21] = PIN(21, GPIO21, 0, 10, pin_GPIO21_af),
    [22] = PIN(22, GPIO22, 0, 11, pin_GPIO22_af),
    [23] = PIN(23, GPIO23, 0, 11, pin_GPIO23_af),
    [24] = PIN(24, GPIO24, 0, 10, pin_GPIO24_af),
    [25] = PIN(25, GPIO25, 0, 10, pin_GPIO25_af),
    [26] = PIN(26, GPIO26, 0, 10, pin_GPIO26_af),
    [27] = PIN(27, GPIO27, 0, 10, pin_GPIO27_af),
    [28] = PIN(28, GPIO28, 0, 9, pin_GPIO28_af),
    [29] = PIN(29, GPIO29, 0, 9, pin_GPIO29_af),
};
